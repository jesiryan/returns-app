...
public class QuantityView extends LinearLayout implements View.OnClickListener {
    ...
    private Drawable quantityBackground, addButtonBackground, removeButtonBackground, addTrayButtonBackground, removeTrayButtonBackground, clearButtonBackground;

    private String addButtonText, removeButtonText, addTrayButtonText, removeTrayButtonText, clearButtonText;
    ...
    private int quantityTextColor, addButtonTextColor, removeButtonTextColor, addTrayButtonTextColor, removeTrayButtonTextColor, clearButtonTextColor;
...
//        void onQuantityChanged(int oldQuantity, int newQuantity, boolean programmatically);
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        addTrayButtonBackground = ContextCompat.getDrawable(getContext(), R.drawable.qv_btn_selector);
        if (a.hasValue(R.styleable.QuantityView_qv_addTrayButtonBackground)) {
        ...
        removeTrayButtonBackground = ContextCompat.getDrawable(getContext(), R.drawable.qv_btn_selector);
        if (a.hasValue(R.styleable.QuantityView_qv_removeTrayButtonBackground)) {
        ...
        clearButtonBackground = ContextCompat.getDrawable(getContext(), R.drawable.qv_btn_selector);
        if (a.hasValue(R.styleable.QuantityView_qv_clearButtonBackground)) {
        ...
        mTrayButtonAdd = new Button(getContext());
        mTrayButtonAdd.setGravity(Gravity.CENTER);
        mTrayButtonAdd.setPadding(dp10, dp10, dp10, dp10);
        mTrayButtonAdd.setMinimumHeight(0);
        mTrayButtonAdd.setMinimumWidth(0);
        mTrayButtonAdd.setMinHeight(0);
        mTrayButtonAdd.setMinWidth(0);
        setAddTrayButtonBackground(addTrayButtonBackground);
        setAddTrayButtonText(addTrayButtonText);
        setAddTrayButtonTextColor(addTrayButtonTextColor);
        ...
        mTrayButtonRemove = new Button(getContext());
        mTrayButtonRemove.setGravity(Gravity.CENTER);
        mTrayButtonRemove.setPadding(dp10, dp10, dp10, dp10);
        mTrayButtonRemove.setMinimumHeight(0);
        mTrayButtonRemove.setMinimumWidth(0);
        mTrayButtonRemove.setMinHeight(0);
        mTrayButtonRemove.setMinWidth(0);
        setRemoveTrayButtonBackground(removeTrayButtonBackground);
        setRemoveTrayButtonText(removeTrayButtonText);
        setRemoveTrayButtonTextColor(removeTrayButtonTextColor);

        mClearButton = new Button(getContext());
        mClearButton.setGravity(Gravity.CENTER);
        mClearButton.setPadding(dp10, dp10, dp10, dp10);
        mClearButton.setMinimumHeight(0);
        mClearButton.setMinimumWidth(0);
        mClearButton.setMinHeight(0);
        mClearButton.setMinWidth(0);
        setClearButtonBackground(clearButtonBackground);
        setClearButtonText(clearButtonText);
        setClearButtonTextColor(clearButtonTextColor);
        ...
        addView(mTrayButtonRemove, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        addView(mTextViewQuantity, LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
        addView(mTrayButtonAdd, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        addView(mButtonAdd, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        addView(mClearButton, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);

        mButtonAdd.setOnClickListener(this);
        mTrayButtonAdd.setOnClickListener(this);
        mButtonRemove.setOnClickListener(this);
        mTrayButtonRemove.setOnClickListener(this);
...
//            if (!quantityDialog) return;
    ...
    public Drawable getAddTrayButtonBackground() {
        return addTrayButtonBackground;
    }

    public void setAddTrayButtonBackground(Drawable addButtonBackground) {
        this.addTrayButtonBackground = addTrayButtonBackground;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            mTrayButtonAdd.setBackground(addTrayButtonBackground);
        } else {
            mTrayButtonAdd.setBackgroundDrawable(addTrayButtonBackground);
        }
    }
    ...
    public Drawable getRemoveTrayButtonBackground() {
        return removeTrayButtonBackground;
    }

    public void setRemoveTrayButtonBackground(Drawable removeTrayButtonBackground) {
        this.removeTrayButtonBackground = removeTrayButtonBackground;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            mTrayButtonRemove.setBackground(removeTrayButtonBackground);
        } else {
            mTrayButtonRemove.setBackgroundDrawable(removeTrayButtonBackground);
        }
    }

    public Drawable getClearButtonBackground() { return clearButtonBackground; }

    public void setClearButtonBackground(Drawable clearButtonBackground) {
        this.clearButtonBackground = clearButtonBackground;
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            mClearButton.setBackground(clearButtonBackground);
        } else {
            mClearButton.setBackgroundDrawable(clearButtonBackground);
        }
    }
    ...
    public String getAddTrayButtonText() {
        return addTrayButtonText;
    }

    public void setAddTrayButtonText(String addTrayButtonText) {
        this.addTrayButtonText = addTrayButtonText;
        mTrayButtonAdd.setText(addTrayButtonText);
    }
    ...
    public void setClearButtonText(String clearButtonText) {
        ...
        mClearButton.setText(clearButtonText);
    }

    public String getTrayRemoveButtonText() {
        return removeTrayButtonText;
    }

    public void setRemoveTrayButtonText(String removeTrayButtonText) {
        this.removeTrayButtonText = removeTrayButtonText;
        mTrayButtonRemove.setText(removeTrayButtonText);
    }
...
//            }
    ...
    public int getAddTrayButtonTextColor() {
        return addTrayButtonTextColor;
    }

    public void setAddTrayButtonTextColor(int addTrayButtonTextColor) {
        this.addTrayButtonTextColor = addTrayButtonTextColor;
        mTrayButtonAdd.setTextColor(addTrayButtonTextColor);
    }
    ...
    public int getRemoveTrayButtonTextColor() {
        return removeTrayButtonTextColor;
    }

    public void setRemoveTrayButtonTextColor(int removeTrayButtonTextColor) {
        this.removeTrayButtonTextColor = removeTrayButtonTextColor;
        mTrayButtonRemove.setTextColor(removeTrayButtonTextColor);
    }
    ...
    public void setClearButtonTextColor(int clearButtonTextColor) {
        this.clearButtonTextColor = clearButtonTextColor;
        mClearButton.setTextColor(clearButtonTextColor);
    }
